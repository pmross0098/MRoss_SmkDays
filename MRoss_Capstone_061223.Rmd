...
if(!dir.exists("Outputs/ShinyOutputs")) dir.create("Outputs/ShinyOutputs")
save(Can_shp, AllUS_shp, outUS_rst, outCan_rst, allsites_shp, County_shp, 
     City_shp, WA_shp, buf_shp, 
     file = file.path(out_dir, "ShinyOutputs/ShpData.RData")) 
save(siteregbi_df, days_df, pmaq_df, m2_coef, 
     file = file.path(out_dir, "ShinyOutputs/SmkData.RData")) 
save(outkrig_lst, file = file.path(out_dir, "ShinyOutputs/KrigeData.RData"))
